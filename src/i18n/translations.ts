...
export const translations: Translations = {
  ...
  en: {
    ...
    about: {
      ...
      bio1Html:
        "As a Full Stack Developer, I build end-to-end solutions from functional analysis to software architecture, integrating Java Spring Boot for backend, Angular for frontend, and Kotlin Multiplatform (KMP) for native mobile development, turning complex processes into clear, traceable, and maintainable systems.",
      bio2Html:
    ...
    projects: {
      ...
      "saip_achievement2": "Database normalized to 3NF in PostgreSQL with Flyway versioning and 20+ interrelated tables",
      "saip_achievement3": "Technical documentation and modeling artifacts aligned with RUP, including MCUN, MAN, MCU, and MA",
      "saip_arch": "Service-oriented architecture supported by complex systems analysis, IBM Engineering Rhapsody modeling, central REST API (Spring Boot), Angular SPA frontend, native Android module, PostgreSQL data layer with Flyway migrations, and Supabase S3 document storage.",
      ...
      "saip_feature0": "Robust RESTful backend with Spring Boot (Java), automated Flyway database migrations, and secure authentication",
      ...
      "saip_feature3": "PostgreSQL database normalized up to 3NF with versioned Flyway migration scripts executed automatically upon backend startup",
      "saip_feature4": "Digital case file storage and document management integration using Supabase S3",
      "saip_feature5": "Complex systems modeling with IBM Engineering Rhapsody, covering MCUN, MAN, MCU, and MA artifacts",
      "saip_fullDescription": "Co-developed by a two-person team, this consolidated platform focuses on the digitalization and automation of processes related to Public Information Access Requests (SAIP) and appeals before the TTAIP. It supports the full management cycle of requests, appeals, notifications, reprocessing, document traceability, and legal deadline control. The project integrates complex systems analysis through IBM Engineering Rhapsody, including MCUN, MAN, MCU, and MA modeling, a PostgreSQL database with Flyway versioned migrations, Supabase S3 object storage for documentation, and applies a hybrid RUP–Scrum/Agile methodology to connect structured analysis with iterative delivery.",
      ...
      "saip_layer0_detail": "REST API, JWT authentication, business logic, Flyway migration execution, and data validation",
      ...
      "saip_layer3": "Database & Storage (PostgreSQL & Supabase S3)",
      "saip_layer3_detail": "3NF normalized PostgreSQL schema managed with Flyway migrations upon backend startup, combined with Supabase S3 for document file storage",
      "saip_myContribution": "As co-author within a two-person team, I contributed to functional analysis, process modeling, business rules definition, architecture design, and technical implementation. My contribution focused on transforming complex public transparency workflows into a structured digital platform, applying IBM Engineering Rhapsody for MCUN, MAN, MCU, and MA modeling, and supporting the implementation of the Spring Boot backend (with Flyway database migrations), Angular SPA, native Android module, PostgreSQL data layer, and Supabase S3 document storage under a hybrid RUP–Scrum/Agile approach.",
    ...
    contact: {
      ...
      description:
        "I'm available for new projects, collaborations, and opportunities in backend architecture, full stack software engineering, and mobile development.",
      email: "Email",
      locationLabel: "Location",
      locationValue: "Arequipa, Peru 🇵🇪",
      available: "Available for projects",
      availableDesc:
        "Open to new challenges in Spring Boot backend architecture, cross-platform mobile apps, and full stack development. Let's talk!",
      findMe: "Find me on",
    ...
    footer: {
      ...
      topLabel: "Top",
      tagline: "Full Stack Developer | Spring Boot & Mobile Specialist",
    },
    maintenance: {
  ...
  es: {
    ...
    projects: {
      ...
      "saip_achievement2": "Base de datos normalizada hasta 3FN en PostgreSQL con versionado mediante Flyway y 20+ tablas interrelacionadas",
      "saip_achievement3": "Documentación técnica y artefactos de modelado alineados a RUP, incluyendo MCUN, MAN, MCU y MA",
      "saip_arch": "Arquitectura orientada a servicios respaldada por análisis de sistemas complejos, modelado con IBM Engineering Rhapsody, API REST central en Spring Boot, frontend SPA en Angular, módulo Android nativo, capa de datos en PostgreSQL gestionada con Flyway y almacenamiento documental en Supabase S3.",
      ...
      "saip_feature0": "Backend RESTful robusto con Spring Boot (Java), migraciones automatizadas con Flyway y autenticación segura",
      ...
      "saip_feature3": "Base de datos PostgreSQL normalizada hasta 3FN con scripts de migración versionados en Flyway ejecutados automáticamente al iniciar el backend",
      "saip_feature4": "Gestión de expedientes digitales y almacenamiento de documentación sustentatoria utilizando Supabase S3",
      "saip_feature5": "Modelado de sistemas complejos con IBM Engineering Rhapsody, cubriendo artefactos MCUN, MAN, MCU y MA",
      "saip_fullDescription": "Co-desarrollada por un equipo de dos personas, esta plataforma consolidada se enfoca en la digitalización y automatización de procesos relacionados con Solicitudes de Acceso a la Información Pública (SAIP) y apelaciones ante el TTAIP. Soporta el ciclo completo de solicitudes, apelaciones, notificaciones, reprocesos, trazabilidad documental y control de plazos legales. El proyecto integra análisis de sistemas complejos mediante IBM Engineering Rhapsody (MCUN, MAN, MCU, MA), base de datos PostgreSQL con migraciones versionadas vía Flyway, almacenamiento de archivos sustentatorios en Supabase S3 y aplica una metodología híbrida RUP–Scrum/Agile.",
      ...
      "saip_layer0": "Backend (Spring Boot)",
      "saip_layer0_detail": "API REST, autenticación JWT, lógica de negocio, ejecución de migraciones Flyway y validación de datos",
      "saip_layer1": "Frontend (Angular)",
      ...
      "saip_layer3": "Base de datos y Almacenamiento (PostgreSQL & Supabase S3)",
      "saip_layer3_detail": "Esquema normalizado 3FN en PostgreSQL gestionado con migraciones Flyway al iniciar Spring Boot, integrado con Supabase S3 para almacenamiento documental",
      "saip_myContribution": "Como coautor dentro de un equipo de dos personas, contribuí al análisis funcional, modelado de procesos, definición de reglas de negocio, diseño de arquitectura e implementación técnica. Mi aporte se enfocó en transformar flujos complejos de transparencia pública en una plataforma digital estructurada, aplicando IBM Engineering Rhapsody para el modelado del MCUN, MAN, MCU y MA, y apoyando la implementación del backend Spring Boot (con migraciones automatizadas vía Flyway), la SPA en Angular, el módulo Android nativo, la base de datos PostgreSQL y el almacenamiento documental en Supabase S3 bajo un enfoque híbrido RUP–Scrum/Agile.",
    ...
    contact: {
      ...
      description:
        "Estoy disponible para nuevos proyectos, colaboraciones y oportunidades en arquitectura de backend, ingeniería de software full stack y desarrollo móvil.",
      email: "Email",
      locationLabel: "Ubicación",
      locationValue: "Arequipa, Perú 🇵🇪",
      available: "Disponible para proyectos",
      availableDesc:
        "Abierto a nuevos desafíos en arquitectura backend con Spring Boot, apps móviles multiplataforma y desarrollo full stack. ¡Conversemos!",
