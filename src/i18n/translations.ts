...
export const translations: Translations = {
  ...
  es: {
    ...
    projects: {
      ...
      "saip_myContribution": "Lideré el diseño e implementación de toda la solución: modelé los procesos con UML profesional (IBM Rhapsody), diseñé la base de datos normalizada hasta 3FN, construí la API RESTful con Spring Boot, desarrolló el frontend SPA con Angular, y creé la app móvil nativa en Kotlin. Apliqué una metodología híbrida RUP-Scrum para combinar análisis estructurado con agilidad iterativa.",
